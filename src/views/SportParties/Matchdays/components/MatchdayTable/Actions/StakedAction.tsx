...
import { useMatchdayUser, useLpTokenPrice } from 'state/hooks'
import { fetchMatchdayUserDataAsync } from 'state/matchdays'
...
import useUnstakeMatchdays from '../../../hooks/useUnstakeMatchdays'
import DepositModal from '../../DepositModal'
import WithdrawModal from '../../WithdrawModal'
import useStakeMatchdays from '../../../hooks/useStakeMatchdays'
...
const Staked: React.FunctionComponent<StackedActionProps> = ({
  ...
  const { allowance, tokenBalance, stakedBalance, earnings } = useMatchdayUser(pid, id)
  const { onStake } = useStakeMatchdays(pid)
  const { onUnstake } = useUnstakeMatchdays(pid)
