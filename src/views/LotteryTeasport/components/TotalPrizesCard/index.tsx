...
import {useTotalRewards, useTotalRewardsTeasport} from 'hooks/useTickets'
import PastLotteryDataContext from 'contexts/PastLotteryDataContext'
import ExpandableSectionButton from 'components/ExpandableSectionButton/ExpandableSectionButton'
import PrizeGrid from '../PrizeGrid'
import iconTicket from "../img/ticket.png";
import iconTeasport from "../img/TeaSportV1.png";
...
const TotalPrizesCard = () => {
  ...
  const lotteryPrizeAmount = +getBalanceNumber(useTotalRewardsTeasport()).toFixed(0)
    ...
    <Card>
      <CardBody>
        ...
        <CardHeading>
          <Left>
            <IconWrapper>
              <img src={iconTeasport} alt='marketCap' width='50'/>
            </IconWrapper>
            <PrizeCountWrapper>
              <Text fontSize="14px" color="textSubtle">
                {TranslateString(999, 'Total Pot:')}
              </Text>
              <Heading size="lg">{lotteryPrizeWithCommaSeparators} TEASPORT</Heading>
            </PrizeCountWrapper>
          </Left>
          <Right>
